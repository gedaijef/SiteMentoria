...
function prepararPopupConfirmacao(
  ...
  document.getElementsByTagName("body")[0].style.overflow = "hidden"; // Evita o scroll
...
function atualizarPopupAlunos(dataSelecionada, horario, disciplina) {
  // const alunosList = document.getElementById("alunosList");
  // alunosList.innerHTML = ""; // Limpa a lista de alunos

  // const alunos = alunosPorHorario[dataSelecionada][horario][disciplina].alunos;
  // if (alunos.length === 0) {
